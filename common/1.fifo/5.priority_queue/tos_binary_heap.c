...
static inline void bin_heap_item_copy_to(k_bin_heap_t *bin_heap, void *item_out, size_t *item_size)
{
...
static inline void bin_heap_item_copy_from(k_bin_heap_t *bin_heap, void *item_in)
{
    memcpy(BIN_HEAP_LAST_ITEM(bin_heap), item_in, bin_heap->item_size);
}

static inline void bin_heap_item_increase(k_bin_heap_t *bin_heap)
{
    ++bin_heap->total;
}

static inline void bin_heap_item_decrease(k_bin_heap_t *bin_heap)
{
    --bin_heap->total;
}

static void bin_heap_do_percolate_up(k_bin_heap_t *bin_heap, uint16_t hole, void *item_backup)
{
    k_bin_heap_cmp cmp;
    size_t item_size;
    uint16_t parent, top;
...
static void bin_heap_percolate_up(k_bin_heap_t *bin_heap, void *item_backup)
{
    bin_heap_do_percolate_up(bin_heap, bin_heap->total, item_backup);
}

static void bin_heap_percolate_down(k_bin_heap_t *bin_heap)
{
    k_bin_heap_cmp cmp;
    size_t item_size;
