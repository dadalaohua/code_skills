...
int main(int argc, char* argv[])
{
    ...
    printf("Init: ");
    test(BITARRAY_B_IS_IN(bitArray, number));
 
    //9放到位数组上
    BITARRAY_B_SET(bitArray, number);
    printf("BITARRAY_B_SET: ");
    test(BITARRAY_B_IS_IN(bitArray, number));
    
    BITARRAY_B_SET(bitArray, 3);
    printf("BITARRAY_B_SET: ");
    test(BITARRAY_B_IS_IN(bitArray, 3));
    ...
    //9从位数组上清除
    BITARRAY_B_CLR(bitArray, number);
    printf("BITARRAY_B_CLR: ");
    test(BITARRAY_B_IS_IN(bitArray, number));
