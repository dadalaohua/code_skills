...
int main(int argc, char* argv[])
{
    ...
    printf("%s: %Lf\n", str1, strtold(str1, NULL));
    printf("%s: %Lf\n", str2, strtold(str2, NULL));
    printf("%s: %Lf\n", str3, strtold(str3, NULL));
    printf("%s: %Lf\n", str4, strtold(str4, NULL));
    printf("%s: %Lf\n", str5, strtold(str5, NULL));
    printf("\n");
    
    printf("%s: %Lf\n", str4, strtold(str4, &ptr));
    printf("%s: %s\n", str4, ptr);
    printf("\n");
    
    printf("%s: %Lf\n", str5, strtold(str5, &ptr));
    printf("%s: %s\n", str5, ptr);
    printf("\n");
    
    printf("%s: %Lf\n", str6, strtold(str6, &ptr));
    printf("%s: %Lf\n", str6, strtold(ptr, NULL));
    printf("\n");
    
    printf("%s: %Lf\n", str7, strtold(str7, NULL));
    printf("%s: %Lf\n", str8, strtold(str8, NULL));
    printf("%s: %Lf\n", str9, strtold(str9, NULL));
    printf("%s: %Lf\n", str10, strtold(str10, NULL));
    printf("%s: %Lf\n", str11, strtold(str11, NULL));
