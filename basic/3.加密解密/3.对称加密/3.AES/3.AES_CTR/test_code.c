...
void test_function_1(void)
{
    ...
    AesCtrXorWithKey(key_128, AES_KEY_SIZE_128, IV, InBuffer, OutBuffer, sizeof(InBuffer));
    printf("Encrypt:\n");
    ...
    AesCtrXorWithKey(key_128, AES_KEY_SIZE_128, IV, OutBuffer, InBuffer, sizeof(InBuffer));
    printf("\n");
    for(i = 0; i < sizeof(InBuffer); i++)
    {
        printf("%2.2x", InBuffer[i]);
...
void test_function_2(void)
{
    ...
    AesCtrInitialiseWithKey(&aesCtr, key_128, AES_KEY_SIZE_128, IV);
    AesCtrOutput(&aesCtr, InBuffer, sizeof(InBuffer));
    // Display
    for(i = 0; i < sizeof(InBuffer); i++)
    {
        printf("%2.2x", InBuffer[i]);
