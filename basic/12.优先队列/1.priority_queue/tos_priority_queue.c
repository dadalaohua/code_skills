...
static inline void prio_q_item_copy_to(k_prio_q_t *prio_q, void *item_out, size_t *item_size, prio_q_slot_t slot)
{
...
static inline void prio_q_item_copy_from(k_prio_q_t *prio_q, void *item_in, prio_q_slot_t slot)
{
    memcpy(PRIO_Q_THE_ITEM(prio_q, slot), item_in, prio_q->item_size);
}

static inline void prio_q_item_increase(k_prio_q_t *prio_q)
{
    ++prio_q->total;
}

static inline void prio_q_item_decrease(k_prio_q_t *prio_q)
{
    --prio_q->total;
}

static void prio_q_pool_mgr_init(prio_q_pool_mgr_t *pool_mgr, prio_q_pool_mgr_ent_t *pool_mgr_ent_array, size_t item_cnt)
{
    prio_q_slot_t i;
...
static void prio_q_pool_mgr_reset(prio_q_pool_mgr_t *pool_mgr, size_t item_cnt)
{
    prio_q_slot_t i;
...
static void prio_q_pool_mgr_deinit(prio_q_pool_mgr_t *pool_mgr)
{
    pool_mgr->first_free            = (prio_q_slot_t)0u;
    pool_mgr->pool_mgr_ent_array    = K_NULL;
}

static int prio_q_mgr_entry_cmp(void *first, void *second)
{
...
static void prio_q_prio_mgr_init(prio_q_prio_mgr_t *prio_mgr, prio_q_prio_mgr_ent_t *prio_mgr_ent_pool, size_t item_cnt)
{
...
static void prio_q_prio_mgr_reset(prio_q_prio_mgr_t *prio_mgr)
{
    tos_bin_heap_flush(&prio_mgr->prio_mgr_bin_heap);
}

static void prio_q_prio_mgr_deinit(prio_q_prio_mgr_t *prio_mgr)
{
    prio_mgr->prio_mgr_ent_pool = K_NULL;
    tos_bin_heap_destroy(&prio_mgr->prio_mgr_bin_heap);
}

static prio_q_slot_t prio_q_pool_mgr_slot_alloc(prio_q_pool_mgr_t *pool_mgr)
{
    prio_q_slot_t fresh;
...
static void prio_q_pool_mgr_slot_free(prio_q_pool_mgr_t *pool_mgr, prio_q_slot_t slot)
{
...
static void prio_q_prio_mgr_slot_enqueue(prio_q_prio_mgr_t *prio_mgr, prio_q_slot_t slot, k_prio_t prio)
{
    ...
    tos_bin_heap_push(&prio_mgr->prio_mgr_bin_heap, &prio_mgr_entry, sizeof(prio_q_prio_mgr_ent_t));
}

static prio_q_slot_t prio_q_prio_mgr_slot_dequeue(prio_q_prio_mgr_t *prio_mgr, k_prio_t *prio)
{
    size_t dummy;
    prio_q_prio_mgr_ent_t prio_mgr_entry;

    tos_bin_heap_pop(&prio_mgr->prio_mgr_bin_heap, &prio_mgr_entry, &dummy);
...
void prio_q_do_enqueue(k_prio_q_t *prio_q, void *item, prio_q_slot_t slot, k_prio_t prio)
{
...
static void prio_q_do_dequeue(k_prio_q_t *prio_q, void *item, size_t *item_size, prio_q_slot_t slot)
{
